...
SELECT pg_catalog.setval('public.rock_rock_id_seq', 1, false);
...
--
-- Name: moon uniq_name_moon; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.moon
    ADD CONSTRAINT uniq_name_moon UNIQUE (name);


--
-- Name: planet uniq_name_planet; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.planet
    ADD CONSTRAINT uniq_name_planet UNIQUE (name);


--
-- Name: star uniq_name_star; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.star
    ADD CONSTRAINT uniq_name_star UNIQUE (name);
